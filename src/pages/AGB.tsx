      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold mb-8 text-primary">Allgemeine Geschäftsbedingungen</h2>
            
            <div className="space-y-8">
              <div className="bg-muted p-8 rounded-lg border border-border">
                <h3 className="text-xl font-semibold mb-4 text-primary">Geltungsbereich</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 1 Geltungsbereich</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 2 Vertragsschluss</h3>
                <p className="text-foreground leading-relaxed mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 3 Preise und Zahlungsbedingungen</h3>
                <p className="text-foreground leading-relaxed mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 4 Lieferung und Leistung</h3>
                <p className="text-foreground leading-relaxed mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 5 Gewährleistung</h3>
                <p className="text-foreground leading-relaxed mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 6 Haftung</h3>
                <p className="text-foreground leading-relaxed mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">§ 7 Schlussbestimmungen</h3>
                <p className="text-foreground leading-relaxed mb-4">
