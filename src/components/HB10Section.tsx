...
const HB10Section = () => {
  return (
    <section className="py-0">
      {/* Blue background header with image and title */}
      <div className="relative w-full h-[200px] bg-[#002454] overflow-hidden">
        <div className="container mx-auto px-4 h-full relative">
          {/* HB10 Image positioned in lower left */}
          ...
          {/* Title box and text on the right */}
      ...
      <div className="bg-slate-50 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-[#002454] mb-8 text-center">
              Das neue Erfolgsmodell - jetzt noch besser.
            </h2>
            <p className="text-lg text-[#002454] max-w-4xl mx-auto text-center">
          ...
          <div className="mb-16">
            <h3 className="text-3xl font-bold text-[#002454] mb-4 text-center">
              Spiele und Optionen
            </h3>
            <p className="text-lg text-[#002454] max-w-4xl mx-auto text-center mb-8">
          ...
          <div className="mb-16">
            <h3 className="text-3xl font-bold text-[#002454] mb-8 text-center">
              HB10 - Monitorkit
            </h3>
